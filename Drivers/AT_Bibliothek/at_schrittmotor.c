...
/*ohne diese VerzÃ¶gerung funktioniert der Treiber nicht korrekt*/
   HAL_Delay(100);
   anschluss = i;
   dSPIN_Reset_Device();
/* 
 * prüft ob irgendetwas zurück kommt, wenn ja dann ist das modul angesteckt
 * diese Info wird genutzt um bei der Initialisierung auszugeben, welche 
 * module aktiv sind. 
 * Es wird immer +1 dazugezählt und um ein bit nach links geschoben
 */ 
