...
//Funktioniert
	uint8_t data=0x00;
	TM_I2C_Read(STMPE811_I2C, STMPE811_ADDRESS, STMPE811_INT_CTRL, &data);
	data |= 0x03;
	TM_I2C_Write(STMPE811_I2C, STMPE811_ADDRESS, STMPE811_INT_CTRL,data);

//Funktioniert
	TM_I2C_Read(STMPE811_I2C, STMPE811_ADDRESS, STMPE811_INT_EN, &data);
	data |= 0x01;
	TM_I2C_Write(STMPE811_I2C, STMPE811_ADDRESS, STMPE811_INT_EN,data);
...
uint8_t TM_STMPE811_Read(uint8_t reg) {
	...
	uint8_t data;
	TM_I2C_Read(STMPE811_I2C, STMPE811_ADDRESS, reg, &data);	
